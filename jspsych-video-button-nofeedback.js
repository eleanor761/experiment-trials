 ...
 */
var jsPsychVideoButtonNoFeedback = (function (jspsych) {
  'use strict';

  const info = {
    name: 'video-button-nofeedback',
    parameters: {
      /** 
   ...
   */
  class VideoButtonNoFeedbackPlugin {
    constructor(jsPsych) {
  ...
  VideoButtonNoFeedbackPlugin.info = info;

  return VideoButtonNoFeedbackPlugin;
})(jsPsychModule);

// This makes the plugin accessible to the experiment in jsPsych 7.x
if (typeof jsPsychModule !== 'undefined') {
  jsPsychModule.VideoButtonNoFeedbackPlugin = jsPsychVideoButtonNoFeedback;
}